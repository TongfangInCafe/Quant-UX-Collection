---
title: "Comparable Regression Analysis 3 Non-Interact"
author: "Tongfang Sun"
date: "August 5, 2016"
...
```{r dataset_format}
train_dat <-  read.table("C:/Users/z003nefs/Downloads/website_aesthetic/exp3/train_list_color_complx.txt", quote="\"", comment.char="")
valid_dat <- read.table("C:/Users/z003nefs/Downloads/website_aesthetic/exp3/valid_list_color_complx.txt", quote="\"", comment.char="")
test_dat <- read.table("C:/Users/z003nefs/Downloads/website_aesthetic/exp3/test_list_color_complx.txt", quote="\"", comment.char="")
...
```{r regression_model}
n.lm <- lm(rate ~ color + compl, data = dat_tarin)
summary(n.lm)
anova(n.lm)
par(mfrow=c(2,2))                 
plot(n.lm)
...
gg <- as.numeric(n.lm$coefficients)
manuel_list = c(1:length(rate))
for (i in 1: length(mytest$rate)) {
  manuel_list[i] = gg[1] + gg[2] * mytest$color[i] + gg[3] * mytest$compl[i]
}
manuel_list
